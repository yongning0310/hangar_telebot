#add seats (automatically adds one more seat)
#mark seats as broken (by seat_id)
#view seats avail (by date)

#add company (name, password, quota) (prevent duplicate names)
#delete company (by company id)
#edit copmany (by company id, edit quota/password)
